...
mcmc.samples<- nimbleMCMC(code = model,constants = constants,data = d,niter = 10000, nchains = 2, thin=1, nburnin = 2000, monitors=c('r1','r2','mu','theta'), inits=inits, samplesAsCodaMCMC=TRUE,setSeed=c(123,456))
