...
tiff(file=here('figures','figure2.tiff'),width=8,height=7,res=800,units='in')
...
tiff(file=here('figures','figure3.tiff'),width=5,height=7,res=800,units='in')
...
tiff(file=here('figures','figure5.tiff'),width=8,height=8,res=800,units='in')
